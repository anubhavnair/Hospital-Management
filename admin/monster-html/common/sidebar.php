                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="dashboard.php" aria-expanded="false"><i class="me-3 far fa-clock fa-fw"
                                    ...
                                    <!-- Add category-->
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                        href="all_cat.php" aria-expanded="false"><i class="me-3 fa fa-list-alt"
                        aria-hidden="true"></i><span class="hide-menu">All Category</span></a></li>
                        
                                    <!-- Manage Doctor -->
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="m_doctor.php" aria-expanded="false"><i class="me-3 fa fa-user-md"
                                    aria-hidden="true"></i><span class="hide-menu">Manage Doctor</span></a>
                        </li>
                        <!-- Manage Medical -->
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="m_medical.php" aria-expanded="false"><i class="me-3 fa fa-medkit"
                                    aria-hidden="true"></i><span class="hide-menu">Manage Medicines</span></a>
                        </li>
                        <!-- Manage Patient -->
                         <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="m_patient.php" aria-expanded="false"><i class="me-3 fa fa-user"
                                    aria-hidden="true"></i><span class="hide-menu">Manage Patient</span></a>
                        </li>
                        <!-- Logout -->
                       <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
